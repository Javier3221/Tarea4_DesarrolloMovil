...
public class MalePhrases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_phrases);
        ...
        userGender.setBackgroundResource(R.drawable.male_user);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(MalePhrases.this);
    ...
    private int pickRandomImage(){
        ...
        imageList.add(R.drawable.male_1);
        imageList.add(R.drawable.male_2);
        imageList.add(R.drawable.male_3);
        imageList.add(R.drawable.male_4);
        imageList.add(R.drawable.male_5);
